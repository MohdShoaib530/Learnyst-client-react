...
function ContactUs() {
  ...
  return (
    <div className=' relative flex items-center justify-center pt-36 pb-8 w-full'>
      <form
        action=''
        noValidate
        onSubmit={onFormSubmit}
        className='border border-black flex flex-col justify-center gap-3  rounded-lg  px-4 py-1 w-fit'
      >
